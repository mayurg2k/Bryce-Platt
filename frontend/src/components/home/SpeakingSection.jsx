          ...
          <div className="lg:col-span-7">
            ...
            <ul className="divide-y divide-[#D8CFBE] border-y border-[#D8CFBE]">
              {speakingTopics.map((t, i) => (
                <li key={t} className="group flex items-center gap-6 py-5">
                  ...
                  <ArrowUpRight className="w-4 h-4 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all ink" />
                </li>
              ))}
            </ul>
            <div className="mt-10">
