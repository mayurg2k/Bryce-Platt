          ...
          <Reveal delay={120}>
            <div className="mt-10 grid lg:grid-cols-12 gap-10 items-start">
              <p className="lg:col-span-7 text-lg lg:text-xl ink-muted leading-relaxed">
                Bryce&rsquo;s career has been dedicated to understanding — and explaining — the systems that shape patient access, affordability, and healthcare economics. He built one of the fastest-growing educational brands in healthcare by choosing clarity over commentary and evidence over opinion.
              </p>
                ...
                <Reveal key={t.year} delay={i * 60}>
                  <div className="grid lg:grid-cols-12 gap-6 items-center relative">
                    <div className="lg:col-span-2 flex items-center gap-4">
                      <div className="relative z-10"><OrgLogo code={codes[i] || "KU"} label={t.label} /></div>
